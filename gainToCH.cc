...
if (argc<2){
	cout << " 									   " << "\n";
	cout << "Modo de empleo: gainToCH [FICHERO](sin extens.) [Nom-1ºSer] [Nombre-2ºSer]  " << "\n";
	cout << "		          				  	           " << "\n";
...
TH1F *hr = c1->DrawFrame(0,0,8000,8000);      
...
TF1 *f1 = new TF1("f1",fitf,800,2000); 
TF1 *f2 = new TF1("f2",fitf,10,8000); 
