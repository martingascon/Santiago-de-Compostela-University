...
TH1F *hr = c1->DrawFrame(0,0,1000,15);      

hr->SetXTitle("Amplifier Gain");		// Escribe como titulo del eje x lo que hay en ejex
...
if (argc<2){
	cout << " 									   " << "\n";
	cout << "Modo de empleo: gainToR [FICHERO](sin extens.) [Nom-1ºSer] [Nombre-2ºSer]  " << "\n";
	cout << "		          				  	           " << "\n";
...
TF1 *f1 = new TF1("f1",fitf,1700,2000); 
...
TF1 *f2 = new TF1("f2",fitf,1800,2000); 
