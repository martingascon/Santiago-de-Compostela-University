...
TH1F *hr = c1->DrawFrame(0,0,12,25);      

hr->SetXTitle("Shaping time (#mu s)");		// Escribe como titulo del eje x lo que hay en ejex
...
f4->SetParameter(0,6);				
f4->SetParameter(1,-30);
f4->SetParameter(2,0.01);
f4->SetParameter(3,-3);
f4->SetParameter(4,0.01);
f5->SetParameter(0,6);				
f5->SetParameter(1,-30);
f5->SetParameter(2,0.01);
f5->SetParameter(3,-3);
f5->SetParameter(4,0.01);
