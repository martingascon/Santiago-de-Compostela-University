...
#define Gain 90500/(2*L)	                 // Parametro de FIR
...
Float_t x[N],datosy[N],datosy2[N],suple,Emin1,Ezer1,Emin2,Ezer2; 
...
Int_t i,j,k,k1=0,k2=0,k3=0,k4=0,k5=0,k6=0,m,nini=0, nfin=7999;           //ficheros inicial y finalTH1I *H1 = new TH1I("H1",arch,8192,0,8191); 
TH1I *H2 = new TH1I("H2",arch,8192,0,8191); 
TH1I *H3 = new TH1I("H3",arch,8192,0,8191); 
TH1I *H4 = new TH1I("H3",arch,8192,0,8191); 
...
{	m=sprintf(arch,"%d.txt",j);  				//cargo en arch el nombre del fichero
	...
	else    
	{
		...
		//Emax2= (phi2[k2-1]+phi2[k2]+phi2[k2+1])/3.0;

/*		for (k=k1;k<800;k++)
			if (phi1[k]<0)          	 	// calculo el cero 
				{	
				k3=k;				
				Ezer1=phi1[k];
  				Tzer1=k3;
...
*/
		...
		//if ((Emax1>1.99) && (Emax1<2.02)) cout << j  << endl;
	       	//*out << Emax2 << " " << Tzer2 << " " << Tmin2 << endl;   // para escribir el histograma 1 en un fichero mca llamado espectro	
