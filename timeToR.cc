...
TH1F *hr = c1->DrawFrame(0,0,420,15);      

hr->SetXTitle("Acquisition time (s)");		// Escribe como titulo del eje x lo que hay en ejex
...
TF1 *f1 = new TF1("f1",fitf2,0.5,420); 
...
TF1 *f2 = new TF1("f2",fitf,0.5,420); 
