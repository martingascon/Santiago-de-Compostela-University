...
TH1F *hr = c1->DrawFrame(0,0,1300,8000);      
...
for (k=0;k<i-1;k++)
	...
	ey4[k]=errory4[k];
	ey5[k]=errory5[k];
cout << datosx[k] << " " << errorx[k] << " " << datosy[k] << " " << errory[k] << " " << datosy2[k] << " " << errory2[k] << " " << datosy3[k] << " " << errory3[k] << " " << datosy4[k] << " " << errory4[k] << " " << datosy5[k] << " " << errory5[k] << endl;  
...
TF1 *f1 = new TF1("f1",fitf,(mins[0]-5),(maxs[0]+5)); 
TF1 *f2 = new TF1("f2",fitf,(mins[1]-5),(maxs[1]+5));
TF1 *f3 = new TF1("f3",fitf,(mins[2]-5),(maxs[2]+5));
TF1 *f4 = new TF1("f4",fitf,(mins[3]-5),(maxs[3]+5));
TF1 *f5 = new TF1("f5",fitf,(mins[4]-5),(maxs[4]+5));
