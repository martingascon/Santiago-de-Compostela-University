...
Float_t mean,sigma,newtrigger, dmean,dsigma,datosy1[N],datosy2[N],datosx[N],x[N],y1[N],y2[N]; 		      
...
TGraph *gr1 = new TGraph(k,x,y1);			// Declaración del gráfico 1.
