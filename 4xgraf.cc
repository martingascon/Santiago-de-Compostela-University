...
#define N 40				       // Número máximo de Datos 
using namespace std;
...
char fich[100],serie1[12]="det. 1",serie2[12]="det. 2",serie3[12]="det. 3",serie4[12]="det. 4";
...
TH1F *hr = c1->DrawFrame(0,0,7000,6250);      

hr->SetXTitle("Total energy peak (channels)");		// Escribe como titulo del eje x lo que hay en ejex
hr->SetYTitle("Proton energy (MeV)");   	        // Escribe como titulo del eje y lo que hay en ejey
...
for (k=0;k<N;k++)			// inicializar variables
	{
...
TGraphErrors *gr1 = new TGraphErrors(i,x1,y1,ex1,ey1);			// Declaración del gráfico 1.
TGraphErrors *gr2 = new TGraphErrors(j,x2,y2,ex2,ey2);			// Declaración del gráfico 2.
TGraphErrors *gr3 = new TGraphErrors(k,x3,y3,ex3,ey3);	
TGraphErrors *gr4 = new TGraphErrors(l,x4,y4,ex4,ey4);	
/*
...
TF1 *f1 = new TF1("f1","([0]+[1]*x+[2]*x*x)",0,2500); 
TF1 *f2 = new TF1("f2","([0]+[1]*x+[2]*x*x)",0,2500);
TF1 *f3 = new TF1("f3","([0]+[1]*x+[2]*x*x)",0,2500);
TF1 *f4 = new TF1("f4","([0]+[1]*x+[2]*x*x)",0,2500);


*/
TF1 *f1 = new TF1("f1","pol1",10,6500); 
TF1 *f2 = new TF1("f2","pol1",10,6500);
TF1 *f3 = new TF1("f3","pol1",10,6500);
TF1 *f4 = new TF1("f4","pol1",10,6500);
