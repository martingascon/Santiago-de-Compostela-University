...
char tituloa[100]="Yokogawa 9140DL (ch1)",titulob[100]="Yokogawa 9140DL (ch2) ",tituloc[100]="XFIR de ch1",titulod[100]="XFIR de ch2 ",arch[100],ci[100]="", ejex[100]="tiempo (puntos)",ejey[100]="voltaje (V)";
...
TGraph *gr2 = new TGraph(I-F,x,phi2);			// Declaración del gráfico.
...
gr2->SetTitle(titulod);					// Escribe como título del grafico lo que hay en titulo
...
TGraph *gr4 = new TGraph(N,x,y2);			// Declaración del gráfico.
