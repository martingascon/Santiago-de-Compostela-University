...
char arch[100],arch2[100],arch3[100]="../pulsos/tiempos3x.txt",ci[100]="", *dat0, *dat1, *dat2, *dat3, *dat4, *dat5;
...
if (argc<2){
	cout << " 									" << "\n";
	cout << "Modo de uso: yoko_csv2txt3x [N_ini] [N_fin] [Z]  		        " << "\n";
	cout << "		          				  	        " << "\n";
...
system("clear");
cout << "Programa para pasar archivos CSV a pulsos en TXT"  << endl;
cout << "****************************************************"  << endl;
		...
		*out << " <<START>> " << endl;		
		...
		for (i=0;i<(N-1);i++)                                        // cargo los datos en datosy, y2
			...
			*in >> ci; 
			...
			x[i]=atof(dat1); y[i]=atof(dat2); y2[i]=atof(dat3);
			*out << x[i] << " " << y[i] << " " << y2[i]  <<  endl;
			}   
		*out << " <<END>> " << endl;	               
		delete out;
