...
char ch, titulo[100]="Spectrum",arch[100],ci[100]="",ejex[100]="time (channels)",ejey[100]="voltage (V)",tituloa[100]="Yokogawa 9140DL (ch1)",titulob[100]="Yokogawa 9140DL (ch2) ",tituloc[100]="XFIR de ch1",titulod[100]="XFIR de ch2";
...
gr3->GetXaxis()->SetTitle("FIR Amplitude (a.u.)");	// Escribe como titulo del eje x lo que hay en ejex
...
gr4->GetXaxis()->SetTitle("FIR Amplitude (a.u.)");	// Escribe como titulo del eje x lo que hay en ejex
...
{	m=sprintf(arch,"%d.txt",j);  				//cargo en arch el nombre del fichero
	...
	else    
	{
		...
		c1->cd(1);
		TGraph *gr1 = new TGraph(N,x,y1);gr1->Draw("AL");	
		c1->cd(2);
		TGraph *gr2 = new TGraph(N,x,y2);gr2->Draw("AL");
